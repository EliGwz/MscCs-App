...
public class FragmentCourseMultimedia extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.inflate(R.layout.fragment_course_multimedia,container,false);
        String stringUrl = "https://www.msc-cs.hku.hk/Curriculum/Courses";
        courseListView = view.findViewById(R.id.multimediaCourseListView);
    ...
    private class DownloadWebpageTask extends AsyncTask<String, Void, Document> {
        ...
        protected void onPostExecute(Document doc){
            ...
            /************** For Financial Computing Stream **********************/
            ArrayList<HashMap<String, Object>> list = new ArrayList<HashMap<String, Object>>();
            HashMap<String, Object> map = null;
            map = new HashMap<String, Object>();
            map.put("course_no", eachLineElements.get(15).select("td").select("p").get(1).text());
            map.put("course_name", eachLineElements.get(15).select("td").select("p").get(2).text());
            list.add(map);
